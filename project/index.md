...
This chapter covers the Phoenix-RTOS project organization: Git submodule structure, repository purposes, the `build.project` entry point, output directories, and Docker-based development.
