...
```{shell-transcript}
[user] cd [user]PRTOS_PROJECT/phoenix-rtos-hostutils/trace
[user] ./collect_rtt_trace.py $MY_OCD_CONFIG $TRACE_DIR
```
...
[user] ./collect_rtt_trace.py ../../evkb_common/ocd/imxrt_wip.cfg output
OpenOCD started
...
you or not, depending on how many times the delay has occurred and how long it
