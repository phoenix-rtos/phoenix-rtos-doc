...
% Set the background color for code blocks and remove the frame (sphinx-specific settings)
\sphinxsetup{
    VerbatimColor={rgb}{0.93,0.93,0.93},
    VerbatimBorderColor={rgb}{0.93,0.93,0.93},
    verbatimwithframe=false,
}

% Decrease font size for code blocks to make them more readable
