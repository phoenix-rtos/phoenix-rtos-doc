...
To understand the microkernel architecture please refer to chapter [Kernel architecture](../kernel/kernel.md).
...
Standard library has been described in [Standard library](../libc/libc.md) chapter.
...
[Device drivers](../devices/devices.md).
...
File servers are described in [Filesystems](../filesystems/filesystems.md) chapter.
