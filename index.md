...
5. [Running system on targets](quickstart/index.md)
    ...
    7. [Running system on `armv8m33-mcxn94x-frdm` (NXP MCX N94x)](quickstart/armv8m33-mcxn94x-frdm.md)
    8. [Running system on `armv8m55-stm32n6-nucleo` (ST STM32N6)](quickstart/armv8m55-stm32n6-nucleo.md)
    9. [Running system on `armv8r52-mps3an536-qemu`](quickstart/armv8r52-mps3an536-qemu.md)
    10. [Running system on `ia32-generic-qemu`](quickstart/ia32-generic-qemu.md)
    11. [Running system on `riscv64-generic-qemu`](quickstart/riscv64-generic-qemu.md)
    12. [Running system on `riscv64-generic-spike`](quickstart/riscv64-generic-spike.md)
    13. [Running system on `riscv64-grfpga-artya7`](quickstart/riscv64-grfpga-artya7.md)
    14. [Running system on `riscv64-gr765-vcu118`](quickstart/riscv64-gr765-vcu118.md)
    15. [Running system on `sparcv8leon-gr716-mini`](quickstart/sparcv8leon-gr716-mini.md)
    16. [Running system on `sparcv8leon-gr712rc-board`](quickstart/sparcv8leon-gr712rc-board)
    17. [Running system on `sparcv8leon-gr716-mimas`](quickstart/sparcv8leon-gr716-mimas)
    18. [Running system on `sparcv8leon-generic-qemu`](quickstart/sparcv8leon-generic-qemu)
    19. [Running system on `sparcv8leon-gr740-mini`](quickstart/sparcv8leon-gr740-mini)
