...
5. [Running system on targets](quickstart/index.md)
    ...
    15. [Running system on `sparcv8leon-gr740-mini`](quickstart/sparcv8leon-gr740-mini)
6. [Loader](loader/index.md)
    1. [Functionality](loader/functionality.md)
    2. [Architecture](loader/architecture.md)
    3. [Command-line interface](loader/cli.md)
