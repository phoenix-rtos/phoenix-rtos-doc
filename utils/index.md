...
This chapter covers the Phoenix-RTOS system utilities: Phoenix Shell (psh) and its applets, standalone utilities, and adding custom psh applets to the build.
