...
To make instructions given in this quickstart possible, you should checkout to `feature/syspage` branch and update submodules before building a system image.
  ...
  After that you can run `build.sh` script for `armv7a9-zynq7000` target architecture.
...
If you don't have one, you can check the running system for this target architecture on an emulator and follow steps from the site below.
