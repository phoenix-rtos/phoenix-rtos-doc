...
to the onboard flash memory, upload the files to offsets on the flash specified by
...
Before starting the system, determine on which serial port the board is connected. To do this, run the
following command:
