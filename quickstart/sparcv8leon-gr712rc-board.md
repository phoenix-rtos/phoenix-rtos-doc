...
```
Phoenix-RTOS loader v. 1.21 rev: 251753a
hal: LEON3FT GR712RC
...
```
(plo)% go!Phoenix-RTOS microkernel v. 3.2 rev: 46d9cd3
hal: SPARCv8 LEON3-GR712RC
hal: GRFPU, 8 windows
hal: Using IRQMP interrupt controller
hal: Using General Purpose Timer
vm: Initializing page allocator (1008+0)/131072KB, page_t=16
vm: [262144x][47K][17H][72A][111H][5P][32516.]
vm: Initializing memory mapper: (8096*64) 518144
...
main: Starting syspage programs: 'dummyfs', 'grlib-multi', 'psh'
dummyfs: initialized
...
(psh)% ps
     PID     PPID PR STATE  %CPU     WAIT       TIME    VMEM THR CMD
       0        0  4 ready 194.7    227ms   00:02:00    1.3M   3 [idle]
       1        0  4 sleep   0.0      1ms   00:00:00       0   1 init
       2        1  4 sleep   0.7      5ms   00:00:00    368K   1 dummyfs
       3        1  2 sleep   2.5      3ms   00:00:02    604K  10 grlib-multi
       4        1  4 ready   1.6      4ms   00:00:01    220K   1 psh
(psh)%
```
